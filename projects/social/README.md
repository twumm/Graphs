...
500 times - Because for 100 users with an average of 10 friends, that will mean we are creating 1000 connections, divided by the factor of 2 since each friend is 2 way(undirected), thus giving us 500 calls to the `add_friendship()` function.
